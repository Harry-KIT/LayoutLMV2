...
if __name__ == "__main__":
    ...
    json_path = os.path.join(args.model_dir, "PARAMS_V2.JSON")
...
# Replace this part in main.py
args = {'local_rank': -1,
        'overwrite_cache': True,
        'data_dir': params.DATA_DIR,  # This is taking the path directly from PARAMS.JSON
...
train_dataloader = get_dataLoader(args, tokenizer, labels, pad_token_label_id, 'training_data', params.BATCH_SIZE)
val_dataloader = get_dataLoader(args, tokenizer, labels, pad_token_label_id, 'testing_data', params.BATCH_SIZE)
...
save_dir = os.path.dirname(params.SAVE_MODEL_PATH)
